...
struct HillStartAssist_
{
  ...
  _mode_type mode;
    ...
    enum { STAT_INACTIVE = 0u };
     enum { STAT_FINDING_GRADIENT = 1u };
     enum { STAT_ACTIVE_PRESSED = 2u };
     enum { STAT_ACTIVE_RELEASED = 3u };
     enum { STAT_FAST_RELEASE = 4u };
     enum { STAT_SLOW_RELEASE = 5u };
     enum { STAT_FAILED = 6u };
     enum { STAT_UNDEFINED = 7u };
     enum { MODE_OFF = 0u };
     enum { MODE_AUTO = 1u };
     enum { MODE_MANUAL = 2u };
     enum { MODE_UNDEFINED = 3u };
