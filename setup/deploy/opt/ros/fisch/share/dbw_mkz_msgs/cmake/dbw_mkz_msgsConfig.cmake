...
if("FALSE" STREQUAL "TRUE")
  set(dbw_mkz_msgs_SOURCE_PREFIX /home/wqkhan/catkin_ws/src/dbw_mkz_msgs)
  set(dbw_mkz_msgs_DEVEL_PREFIX /home/wqkhan/catkin_ws/deploy/devel/.private/dbw_mkz_msgs)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dbw_mkz_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/fisch/${idir}'.  Ask the maintainer 'Kevin Hallenbeck <khallenbeck@dataspeedinc.com>' to fix it.")
    endif()
