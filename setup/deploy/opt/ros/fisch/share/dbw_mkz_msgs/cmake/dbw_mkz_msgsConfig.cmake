...
if("FALSE" STREQUAL "TRUE")
  set(dbw_mkz_msgs_SOURCE_PREFIX /home/waleedqk/catkin_ws/src/dbw_mkz_msgs)
  set(dbw_mkz_msgs_DEVEL_PREFIX /home/waleedqk/catkin_ws/deploy/devel/.private/dbw_mkz_msgs)
  ...
  set(dbw_mkz_msgs_INSTALL_PREFIX /opt/ros/fisch)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dbw_mkz_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/fisch/${idir}'.  ${_report}")
    endif()
