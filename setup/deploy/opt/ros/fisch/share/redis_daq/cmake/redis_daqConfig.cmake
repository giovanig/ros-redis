...
if("FALSE" STREQUAL "TRUE")
  set(redis_daq_SOURCE_PREFIX /home/waleedqk/catkin_ws/src/redis_daq)
  set(redis_daq_DEVEL_PREFIX /home/waleedqk/catkin_ws/deploy/devel/.private/redis_daq)
...
if(NOT "include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'giovani <giovani@todo.todo>, Waleed Khan <wqkhan@uwaterloo.ca>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'redis_daq' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'redis_daq' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/fisch/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;std_msgs;anm_msgs;dbw_mkz_msgs;etrans_msgs")
