...
if("FALSE" STREQUAL "TRUE")
  set(catkin_tools_prebuild_SOURCE_PREFIX /home/waleedqk/catkin_ws/deploy/build/catkin_tools_prebuild)
  set(catkin_tools_prebuild_DEVEL_PREFIX /home/waleedqk/catkin_ws/deploy/devel/.private/catkin_tools_prebuild)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/fisch/${idir}'.  ${_report}")
    endif()
