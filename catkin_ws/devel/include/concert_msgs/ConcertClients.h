...
struct ConcertClients_
{
  ...
  _missing_clients_type missing_clients;
   ...
   typedef std::vector< ::concert_msgs::ConcertClient_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::concert_msgs::ConcertClient_<ContainerAllocator> >::other >  _pending_clients_type;
...
struct MD5Sum< ::concert_msgs::ConcertClients_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x6950d7da025bef00ULL;
  static const uint64_t static_value2 = 0xc62c809b8487d74fULL;
};
...
struct Printer< ::concert_msgs::ConcertClients_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::concert_msgs::ConcertClients_<ContainerAllocator>& v)
  {
    ...
    s << indent << "pending_clients[]" << std::endl;
    for (size_t i = 0; i < v.pending_clients.size(); ++i)
    {
      s << indent << "  pending_clients[" << i << "]: ";
      s << std::endl;
      s << indent;
      Printer< ::concert_msgs::ConcertClient_<ContainerAllocator> >::stream(s, indent + "    ", v.pending_clients[i]);
    }
  }
};
