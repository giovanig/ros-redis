...
"""autogenerated by genpy from rocon_interaction_msgs/Strings.msg. Do not edit."""
import sys
...
class Strings(genpy.Message):
  _md5sum = "7279ef1b62bbde7b3bec17766ef2c127"
  _type = "rocon_interaction_msgs/Strings"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Strings that are constant with respect to the entire concert. Listing them here
