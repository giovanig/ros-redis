...
"""autogenerated by genpy from concert_service_msgs/KillTurtlePairRequest.msg. Do not edit."""
import sys
...
class KillTurtlePairRequest(genpy.Message):
  _md5sum = "0f974aecea7bf5add789608093b710e2"
  _type = "concert_service_msgs/KillTurtlePairRequest"
...
"""
  ...
  _slot_types = ['uuid_msgs/UniqueID','concert_service_msgs/KillTurtleRequest']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(KillTurtlePairRequest, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.id is None:
        self.id = uuid_msgs.msg.UniqueID()
      if self.request is None:
        self.request = concert_service_msgs.msg.KillTurtleRequest()
    else:
      self.id = uuid_msgs.msg.UniqueID()
      self.request = concert_service_msgs.msg.KillTurtleRequest()
