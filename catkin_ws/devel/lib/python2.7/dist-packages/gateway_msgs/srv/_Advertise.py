...
"""autogenerated by genpy from gateway_msgs/AdvertiseRequest.msg. Do not edit."""
import sys
...
class AdvertiseRequest(genpy.Message):
  _md5sum = "85ef604243258e1594c5a7401f5e0339"
  _type = "gateway_msgs/AdvertiseRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AdvertiseRequest, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_B().pack(self.cancel))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.cancel,) = _get_struct_B().unpack(str[start:end])
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from gateway_msgs/AdvertiseResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class AdvertiseResponse(genpy.Message):
  _md5sum = "c389af2721ca403446acba93862aff4f"
  _type = "gateway_msgs/AdvertiseResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
...
string node
"""
  __slots__ = ['result','error_message','watchlist']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AdvertiseResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
class Advertise(object):
  _type          = 'gateway_msgs/Advertise'
  _md5sum = '394a2b6787bc0694573ae81a1842f14b'
  _request_class  = AdvertiseRequest
  _response_class = AdvertiseResponse
