...
"""autogenerated by genpy from gateway_msgs/RemoteRuleWithStatus.msg. Do not edit."""
import sys
...
class RemoteRuleWithStatus(genpy.Message):
  _md5sum = "7892d8834068a87e345fff91adc26a5e"
  _type = "gateway_msgs/RemoteRuleWithStatus"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# The remote rule whose status is being defined here
...
"""
  ...
  __slots__ = ['remote_rule','status']
  _slot_types = ['gateway_msgs/RemoteRule','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RemoteRuleWithStatus, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.remote_rule is None:
        self.remote_rule = gateway_msgs.msg.RemoteRule()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      _x = self.remote_rule.gateway
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.remote_rule.rule.type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.remote_rule.rule.name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.remote_rule.rule.node
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.remote_rule.gateway = str[start:end].decode('utf-8')
      else:
        self.remote_rule.gateway = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.remote_rule.rule.type = str[start:end].decode('utf-8')
      else:
        self.remote_rule.rule.type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.remote_rule.rule.name = str[start:end].decode('utf-8')
      else:
        self.remote_rule.rule.name = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.remote_rule.rule.node = str[start:end].decode('utf-8')
      else:
        self.remote_rule.rule.node = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
