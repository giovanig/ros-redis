...
class ConcertClients(genpy.Message):
  _md5sum = "6950d7da025bef00c62c809b8487d74f"
...
string key
string value"""
  __slots__ = ['clients','missing_clients','pending_clients']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       clients,missing_clients,pending_clients
    ...
    if args or kwds:
      ...
      if self.pending_clients is None:
        ...
        for val2 in val1.rapps:
          ...
          for val3 in val2.public_parameters:
            ...
            if python3 or type(_x) == unicode:
              ...
              length = len(_x)
            buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.pending_clients)
      buff.write(_struct_I.pack(length))
      for val1 in self.pending_clients:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v13.rocon_uri = str[start:end].decode('utf-8')
        else:
          _v13.rocon_uri = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v13.description = str[start:end].decode('utf-8')
        else:
          _v13.description = str[start:end]
        _v14 = _v13.icon
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          for i in range(0, length):
            ...
            val2.public_parameters.append(val3)
          val1.rapps.append(val2)
        self.pending_clients.append(val1)
      return self
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v37.rocon_uri = str[start:end].decode('utf-8')
        else:
          _v37.rocon_uri = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v37.description = str[start:end].decode('utf-8')
        else:
          _v37.description = str[start:end]
        _v38 = _v37.icon
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v41.rocon_uri = str[start:end].decode('utf-8')
        else:
          _v41.rocon_uri = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v41.description = str[start:end].decode('utf-8')
        else:
          _v41.description = str[start:end]
        _v42 = _v41.icon
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
      ...
      for i in range(0, length):
        ...
        if python3:
          _v45.name = str[start:end].decode('utf-8')
        else:
          _v45.name = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v45.rocon_uri = str[start:end].decode('utf-8')
        else:
          _v45.rocon_uri = str[start:end]
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          _v45.description = str[start:end].decode('utf-8')
        else:
          _v45.description = str[start:end]
        _v46 = _v45.icon
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
