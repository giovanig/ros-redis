...
"""autogenerated by genpy from concert_msgs/SoftwareProfiles.msg. Do not edit."""
import sys
...
class SoftwareProfiles(genpy.Message):
  _md5sum = "b1749b57e354bf30f98c3179a4fff5d7"
  _type = "concert_msgs/SoftwareProfiles"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """SoftwareProfile[] profiles 
...
string value"""
  __slots__ = ['profiles']
  _slot_types = ['concert_msgs/SoftwareProfile[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SoftwareProfiles, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = concert_msgs.msg.SoftwareProfile()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.launch = str[start:end].decode('utf-8')
        else:
          val1.launch = str[start:end]
        start = end
        end += 2
