...
class MasterInfo(genpy.Message):
  _md5sum = "e85613ae2e3faade6b77d94b4e0bf4bf"
  _type = "rocon_std_msgs/MasterInfo"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Publish basic information about this master.
...
# Image data.
uint8[] data"""
  __slots__ = ['name','rocon_uri','description','icon','version']
  _slot_types = ['string','string','string','rocon_std_msgs/Icon','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       name,rocon_uri,description,icon,version
