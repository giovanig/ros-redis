...
"""autogenerated by genpy from rocon_std_msgs/ConnectionsList.msg. Do not edit."""
import sys
...
class ConnectionsList(genpy.Message):
  _md5sum = "672d6ad69b684884f8fb6f4acedbd39f"
  _type = "rocon_std_msgs/ConnectionsList"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """Connection[] connections
================================================================================
...
string xmlrpc_uri"""
  ...
  _slot_types = ['rocon_std_msgs/Connection[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ConnectionsList, self).__init__(*args, **kwds)
