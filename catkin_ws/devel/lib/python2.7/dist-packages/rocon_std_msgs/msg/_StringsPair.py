...
"""autogenerated by genpy from rocon_std_msgs/StringsPair.msg. Do not edit."""
import sys
...
class StringsPair(genpy.Message):
  _md5sum = "d41c9071bd514be249c417a13ec83e65"
  _type = "rocon_std_msgs/StringsPair"
...
"""
  ...
  _slot_types = ['rocon_std_msgs/StringsPairRequest','rocon_std_msgs/StringsPairResponse']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StringsPair, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.pair_request is None:
        self.pair_request = rocon_std_msgs.msg.StringsPairRequest()
      if self.pair_response is None:
        self.pair_response = rocon_std_msgs.msg.StringsPairResponse()
    else:
      self.pair_request = rocon_std_msgs.msg.StringsPairRequest()
      self.pair_response = rocon_std_msgs.msg.StringsPairResponse()
