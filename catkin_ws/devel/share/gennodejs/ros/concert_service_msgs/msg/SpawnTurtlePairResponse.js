...
let SpawnTurtleResponse = require('./SpawnTurtleResponse.js');
let uuid_msgs = _finder('uuid_msgs');

//-----------------------------------------------------------

class SpawnTurtlePairResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('response')) {
        ...
        this.response = new SpawnTurtleResponse();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SpawnTurtleResponse.serialize(obj.response, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SpawnTurtlePairResponse(null);
    // Deserialize message field [id]
    data.id = uuid_msgs.msg.UniqueID.deserialize(buffer, bufferOffset);
    // Deserialize message field [response]
    data.response = SpawnTurtleResponse.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += SpawnTurtleResponse.getMessageSize(object.response);
    return length + 16;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpawnTurtlePairResponse(null);
    if (msg.id !== undefined) {
    ...
    if (msg.response !== undefined) {
      resolved.response = SpawnTurtleResponse.Resolve(msg.response)
    }
    else {
      resolved.response = new SpawnTurtleResponse()
    }
...
module.exports = SpawnTurtlePairResponse;
