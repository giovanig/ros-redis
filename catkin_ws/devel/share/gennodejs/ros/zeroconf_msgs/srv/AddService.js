...
class AddServiceRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddServiceRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddServiceRequest
    let len;
    let data = new AddServiceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddServiceRequest(null);
...
class AddServiceResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type AddServiceResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type AddServiceResponse
    let len;
    let data = new AddServiceResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AddServiceResponse(null);
...
module.exports = {
  ...
  datatype() { return 'zeroconf_msgs/AddService'; }
};
