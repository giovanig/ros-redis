...
function(add_rocon_test file)
  ...
  find_program_required(ROCON_TEST_EXE rocon_test 
    PATHS /home/giovani/catkin_ws/src/rocon_multimaster/rocon_test/scripts
  ...
  #set(cmd "${ROCON_TEST_EXE} --pkgdir=${PROJECT_SOURCE_DIR} --package=${PROJECT_NAME} --results-base-dir \"${CATKIN_TEST_RESULTS_DIR}\" --results-filename=${_output_name} ${_file_name}")
  set(cmd "${ROCON_TEST_EXE} --results-filename=${_output_name} --results-base-dir \"${CATKIN_TEST_RESULTS_DIR}\" ${PROJECT_NAME} ${_file_name}")
