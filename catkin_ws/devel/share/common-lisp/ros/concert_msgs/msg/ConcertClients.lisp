...
(cl:defclass <ConcertClients> (roslisp-msg-protocol:ros-message)
  ((clients
   ...
   :initform (cl:make-array 0 :element-type 'concert_msgs-msg:ConcertClient :initial-element (cl:make-instance 'concert_msgs-msg:ConcertClient)))
   (pending_clients
    :reader pending_clients
    :initarg :pending_clients
    :type (cl:vector concert_msgs-msg:ConcertClient)
   :initform (cl:make-array 0 :element-type 'concert_msgs-msg:ConcertClient :initial-element (cl:make-instance 'concert_msgs-msg:ConcertClient))))
)
...
(cl:ensure-generic-function 'pending_clients-val :lambda-list '(m))
(cl:defmethod pending_clients-val ((m <ConcertClients>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader concert_msgs-msg:pending_clients-val is deprecated.  Use concert_msgs-msg:pending_clients instead.")
  (pending_clients m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ConcertClients>) ostream)
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'pending_clients))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (roslisp-msg-protocol:serialize ele ostream))
   (cl:slot-value msg 'pending_clients))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ConcertClients>) istream)
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'pending_clients) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'pending_clients)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'concert_msgs-msg:ConcertClient))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ConcertClients>)))
  ...
  "6950d7da025bef00c62c809b8487d74f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ConcertClients)))
  "Returns md5sum for a message object of type 'ConcertClients"
  "6950d7da025bef00c62c809b8487d74f")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ConcertClients>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'pending_clients) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ (roslisp-msg-protocol:serialization-length ele))))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ConcertClients>))
  ...
  (cl:list 'ConcertClients
    ...
    (cl:cons ':pending_clients (pending_clients msg))
))
