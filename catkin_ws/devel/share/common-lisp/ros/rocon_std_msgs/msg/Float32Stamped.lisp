...
(cl:defmethod cl:initialize-instance :after ((m <Float32Stamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Float32Stamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rocon_std_msgs-msg:<Float32Stamped> is deprecated: use rocon_std_msgs-msg:Float32Stamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Float32Stamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rocon_std_msgs-msg:header-val is deprecated.  Use rocon_std_msgs-msg:header instead.")
  (header m))
