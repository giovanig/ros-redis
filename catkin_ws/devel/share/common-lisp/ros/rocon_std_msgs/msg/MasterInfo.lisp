...
(cl:defmethod rocon_uri-val ((m <MasterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rocon_std_msgs-msg:rocon_uri-val is deprecated.  Use rocon_std_msgs-msg:rocon_uri instead.")
  (rocon_uri m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MasterInfo>)))
  ...
  (cl:format cl:nil "# Publish basic information about this master.~%~%string name~%string rocon_uri~%string description~%rocon_std_msgs/Icon icon~%string version~%================================================================================~%MSG: rocon_std_msgs/Icon~%# Used to idenfity the original package/filename resource this icon was/is to be loaded from~%# This typically doesn't have to be set, but can be very useful when loading icons from yaml definitions.~%string resource_name~%~%# Image data format.  \"jpeg\" or \"png\"~%string format~%~%# Image data.~%uint8[] data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MasterInfo)))
  "Returns full string definition for message of type 'MasterInfo"
  (cl:format cl:nil "# Publish basic information about this master.~%~%string name~%string rocon_uri~%string description~%rocon_std_msgs/Icon icon~%string version~%================================================================================~%MSG: rocon_std_msgs/Icon~%# Used to idenfity the original package/filename resource this icon was/is to be loaded from~%# This typically doesn't have to be set, but can be very useful when loading icons from yaml definitions.~%string resource_name~%~%# Image data format.  \"jpeg\" or \"png\"~%string format~%~%# Image data.~%uint8[] data~%~%"))
