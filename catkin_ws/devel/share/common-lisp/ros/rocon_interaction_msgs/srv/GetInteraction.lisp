...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<GetInteraction-request>)))
  ...
  "99b98a8efcdde2712b480273db0f877e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'GetInteraction-request)))
  "Returns md5sum for a message object of type 'GetInteraction-request"
  "99b98a8efcdde2712b480273db0f877e")
