...
(cl:defclass <InteractiveClient> (roslisp-msg-protocol:ros-message)
  ((name
   ...
   (platform_info
    ...
    :type rocon_std_msgs-msg:MasterInfo
    :initform (cl:make-instance 'rocon_std_msgs-msg:MasterInfo))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<InteractiveClient>)))
  ...
  (cl:format cl:nil "# ~%# Describes an interactive concert client.~%#~%# Unique names - human consumable rocon name as well as globally unique name~%# provided by the remocon client.~%~%string name~%uuid_msgs/UniqueID id~%~%rocon_std_msgs/MasterInfo platform_info~%~%# easy to read display names of interactions running on this remocon~%string[] running_interactions~%~%================================================================================~%MSG: uuid_msgs/UniqueID~%# A universally unique identifier (UUID).~%#~%#  http://en.wikipedia.org/wiki/Universally_unique_identifier~%#  http://tools.ietf.org/html/rfc4122.html~%~%uint8[16] uuid~%~%================================================================================~%MSG: rocon_std_msgs/MasterInfo~%# Publish basic information about this master.~%~%string name~%string rocon_uri~%string description~%rocon_std_msgs/Icon icon~%string version~%================================================================================~%MSG: rocon_std_msgs/Icon~%# Used to idenfity the original package/filename resource this icon was/is to be loaded from~%# This typically doesn't have to be set, but can be very useful when loading icons from yaml definitions.~%string resource_name~%~%# Image data format.  \"jpeg\" or \"png\"~%string format~%~%# Image data.~%uint8[] data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'InteractiveClient)))
  "Returns full string definition for message of type 'InteractiveClient"
  (cl:format cl:nil "# ~%# Describes an interactive concert client.~%#~%# Unique names - human consumable rocon name as well as globally unique name~%# provided by the remocon client.~%~%string name~%uuid_msgs/UniqueID id~%~%rocon_std_msgs/MasterInfo platform_info~%~%# easy to read display names of interactions running on this remocon~%string[] running_interactions~%~%================================================================================~%MSG: uuid_msgs/UniqueID~%# A universally unique identifier (UUID).~%#~%#  http://en.wikipedia.org/wiki/Universally_unique_identifier~%#  http://tools.ietf.org/html/rfc4122.html~%~%uint8[16] uuid~%~%================================================================================~%MSG: rocon_std_msgs/MasterInfo~%# Publish basic information about this master.~%~%string name~%string rocon_uri~%string description~%rocon_std_msgs/Icon icon~%string version~%================================================================================~%MSG: rocon_std_msgs/Icon~%# Used to idenfity the original package/filename resource this icon was/is to be loaded from~%# This typically doesn't have to be set, but can be very useful when loading icons from yaml definitions.~%string resource_name~%~%# Image data format.  \"jpeg\" or \"png\"~%string format~%~%# Image data.~%uint8[] data~%~%"))
