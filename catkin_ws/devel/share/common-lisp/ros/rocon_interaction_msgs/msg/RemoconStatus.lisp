...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RemoconStatus>)))
  ...
  (cl:format cl:nil "# Used by the remocons to inform the concert of it's current status. They should~%# publish this as a latched publisher.~%~%rocon_std_msgs/MasterInfo platform_info~%# The remocon id~%# This should be a '32 character Type 4 uuid hex string'~%string uuid~%~%~%# We should be using this, but java can't handle the type, reintegrate when we bugfix.~%# uuid_msgs/UniqueID[] running_interactions~%~%# This is a crc32 hash code we use because of the above.~%int32[] running_interactions~%~%# rocon version compatibility identifier (used when connecting to concerts)~%string version~%~%================================================================================~%MSG: rocon_std_msgs/MasterInfo~%# Publish basic information about this master.~%~%string name~%string rocon_uri~%string description~%rocon_std_msgs/Icon icon~%string version~%================================================================================~%MSG: rocon_std_msgs/Icon~%# Used to idenfity the original package/filename resource this icon was/is to be loaded from~%# This typically doesn't have to be set, but can be very useful when loading icons from yaml definitions.~%string resource_name~%~%# Image data format.  \"jpeg\" or \"png\"~%string format~%~%# Image data.~%uint8[] data~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RemoconStatus)))
  "Returns full string definition for message of type 'RemoconStatus"
  (cl:format cl:nil "# Used by the remocons to inform the concert of it's current status. They should~%# publish this as a latched publisher.~%~%rocon_std_msgs/MasterInfo platform_info~%# The remocon id~%# This should be a '32 character Type 4 uuid hex string'~%string uuid~%~%~%# We should be using this, but java can't handle the type, reintegrate when we bugfix.~%# uuid_msgs/UniqueID[] running_interactions~%~%# This is a crc32 hash code we use because of the above.~%int32[] running_interactions~%~%# rocon version compatibility identifier (used when connecting to concerts)~%string version~%~%================================================================================~%MSG: rocon_std_msgs/MasterInfo~%# Publish basic information about this master.~%~%string name~%string rocon_uri~%string description~%rocon_std_msgs/Icon icon~%string version~%================================================================================~%MSG: rocon_std_msgs/Icon~%# Used to idenfity the original package/filename resource this icon was/is to be loaded from~%# This typically doesn't have to be set, but can be very useful when loading icons from yaml definitions.~%string resource_name~%~%# Image data format.  \"jpeg\" or \"png\"~%string format~%~%# Image data.~%uint8[] data~%~%"))
